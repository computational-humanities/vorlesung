...
** Vorl: Texte und Muster, reguläre Ausdrücke
...
* Zugang
** JupyterHub für HU Studierende
Wenn Studierende für ein Projekt dauerhaften Zugang zu einer Jupyter Notebook Umgebung benötigen, können sie sich 
...
Der entsprechende Username wird vom Administrator benötigt, da die Authentifizierung über Github-Oauth erfolgt. Das Password wird natürlich nicht 
benötigt! Zugang ist wie immer nur aus dem HU Netz möglich.
** Notebooks anschauen
